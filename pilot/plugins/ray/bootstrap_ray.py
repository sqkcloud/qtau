...
class RayBootstrap():
    ...
    def start_ray(self):
        ...
        cmd = "conda activate qtau; ray stop; export RAY_ENABLE_WINDOWS_OR_OSX_CLUSTER=1; ray start --head   --dashboard-host=%s --num-cpus=0 --num-gpus=0 --ray-client-server-port=10001"%(self.ray_headnode_address)
