...
class TestQTauComputeServiceLogger:
    """Tests for QTauComputeServiceLogger class."""
    ...
    def test_singleton_pattern(self, temp_dir):
        ...
        logger1 = QTauComputeServiceLogger(temp_dir)
        logger2 = QTauComputeServiceLogger(temp_dir)
        assert logger1 is logger2

    def test_logger_creates_log_file(self, temp_dir):
        """Test that logger creates log file in working directory."""
        logger = QTauComputeServiceLogger(temp_dir)
